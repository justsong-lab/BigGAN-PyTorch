...
# Code ported from https://github.com/TDeVries/cub2011_dataset/blob/master/cub2011.py
class CUB200(data.Dataset):
  ...
  def __init__(self, root, train=True, transform=None, load_in_mem=True, loader=default_loader, download=True, **kwargs):
    self.root = os.path.expanduser(root)
    self.transform = transform
    self.loader = loader
    self.train = train
    self.local_tgz_path = r"D:\Data\Archive\CUB_200_2011.tgz"
  ...
  def _download(self):
    ...
    # Use a local CUB_200_2011.tgz here.

    with tarfile.open(self.local_tgz_path, "r:gz") as tar:
